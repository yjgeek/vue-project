<template>
  <div class="resource-dialog" @click.self.prevent="$emit('close')">
    <div class="resource-dialog-wrapper">
      ...
      <div class="resource-dialog-footer">
        <el-button @click="$emit('close')" size="small" type="danger">取消</el-button>
        <el-button @click="$emit('submit')" size="small" type="primary">确定</el-button>
      </div>
    </div>
  </div>
</template>
