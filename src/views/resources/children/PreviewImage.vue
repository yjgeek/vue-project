  ...
  <div class="resource-preview-image-dialog">
    ...
    <div class="resource-preview-image-dialog-body">
      ...
      <div class="opearting">
        ...
        <span v-if="currentActive.source_url">
          <img :src="sourceIcon" @click="handleCheckSource('source')">
        </span>
        <a :href="currentActive.url" target="__blank" download>
...
export default {
  ...
  methods: {
    analysisData (val) {
      const { width, height, angle, source_url } = getParams(val.url);
      ...
      if (source_url) {
        this.currentActive.source_url = source_url;
      }
    ...
    handleCheckSource () {
      if (this.currentActive.source_url !== this.currentActive.url) {
        this.currentActive.url = this.currentActive.source_url;
      }
    },
    handleZoom(type) {
      if (type === 'plus') {
